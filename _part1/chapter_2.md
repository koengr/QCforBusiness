...
particles inside it, their velocities, how much they rotate, etcetera.
...
computer memory. For example, for our prototypical particle, we imagine
we’re only interested in its location, which we’ll call $x$ (and we
forget about any other structure in the world). In the spirit of
computing, we might look at a ‘bit’ that stores information. You may
think of it as a tiny magnet that can either point ‘up’ (0) or ‘down’
...
- [QuTech Academy’s ](https://www.qutube.nl/)*<u>School of
  Quantum</u> – *A broad range of topics explained using short videos. 
